...
class WalletServices{
  ...
  getWallets({required WalletProvider walletProvider, required String currency}) {
  ...
  fundWalletNairaTransfer({required String amount, required WalletProvider walletProvider, required TransactionProvider transactionProvider, required String currency}) {
