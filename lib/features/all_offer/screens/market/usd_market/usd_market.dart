...
class UsdMarketScreen extends StatefulWidget {
  const UsdMarketScreen({super.key});

  @override
  State<UsdMarketScreen> createState() => _UsdMarketScreenState();
}

class _UsdMarketScreenState extends State<UsdMarketScreen> {
  int selectedIndex = 1;
