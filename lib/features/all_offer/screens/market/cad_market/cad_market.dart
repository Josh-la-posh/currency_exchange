...
class CadMarketScreen extends StatefulWidget {
  const CadMarketScreen({super.key});

  @override
  State<CadMarketScreen> createState() => _CadMarketScreenState();
}

class _CadMarketScreenState extends State<CadMarketScreen> {
  int selectedIndex = 1;
