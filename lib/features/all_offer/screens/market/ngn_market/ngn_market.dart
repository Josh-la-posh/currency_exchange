...
class NgnMarketScreen extends StatefulWidget {
  const NgnMarketScreen({super.key});

  @override
  State<NgnMarketScreen> createState() => _NgnMarketScreenState();
}

class _NgnMarketScreenState extends State<NgnMarketScreen> {
  int selectedIndex = 1;
