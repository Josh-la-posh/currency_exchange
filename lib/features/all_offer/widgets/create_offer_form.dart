    ...
    return Obx(() => Form(
            ...
            child: Column(
              children: [
                  ...
                  children: [
                    ...
                    SizedBox(
                      child: TextFormField(
                        ...
                        onChanged: (value) {
                          createOfferController.amountController.text = value;
                    ...
                    TextFormField(
                      decoration: InputDecoration(
                        suffixIcon: DropdownButton<Currency>(
                          ...
                          onChanged: (val) {
                            // offerProvider.updateCreditedCurrency(val!);
                            if (val != null) {
                ...
                Column(
                  ...
                  children: [
                    ...
                    TextFormField(
                      ...
                      validator: TValidator.numValidator,
                      onChanged: (value) {
                        // offerProvider.updateRate(value);
                        createOfferController.rateController.text = value;
                        formKey.currentState?.validate();
                        helperFunctionsController.getStringMultiplication(createOfferController.amountController.text, createOfferController.rateController.text);
                      },
                      // onSaved: (val) {
                ...
                TElevatedButton(
                    onTap: createOfferController.amountController.text == '0' ||
                        createOfferController.rateController.text == '0'
                        ? null
                        : (){
