...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return GestureDetector(
      onTap: () => InactivityService.instance.resetTimer(),
      onPanDown: (_) => InactivityService.instance.resetTimer(),
      onScaleStart: (_) => InactivityService.instance.resetTimer(),
      child: GlobalAppLoader(
        app: ErrorBoundary(
          app: GetMaterialApp(
              title: 'pouch',
